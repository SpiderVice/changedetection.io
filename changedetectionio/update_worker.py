...
class update_worker(threading.Thread):
    ...
    def queue_notification_for_watch(self, notification_q, n_object, watch):
        ...
        n_object.update({
            ...
            'diff_added_patch': diff.render_diff(prev_snapshot, current_snapshot, include_removed=False, line_feed_sep=line_feed_sep, patch_format=True),
            ...
            'diff_removed_patch': diff.render_diff(prev_snapshot, current_snapshot, include_added=False, line_feed_sep=line_feed_sep, patch_format=True),
